...
class FakeimgProviderTest extends TestCase
{
    ...
    {
        $this->assertSame(
            'https://fakeimg.cnbattle.com/640x480/CCCCCC/939393',
    ...
    {
        $this->assertSame(
            'https://fakeimg.cnbattle.com/800x600/CCCCCC/939393',
    ...
    {
        $this->assertSame(
            'https://fakeimg.cnbattle.com/800x600/CCCCCC/939393?text=foo+%26+bar',
    ...
    {
        $this->assertSame(
            'https://fakeimg.cnbattle.com/800x600/649664/000000?retina=1&text=foo+%26+bar',
            FakeimgProvider::fakeImgUrl(
                800,
                600,
                'foo & bar',
    ...
    {
        $this->assertSame(
            'https://fakeimg.cnbattle.com/800x600/649664,128/000000,10?retina=1&text=foo+%26+bar',
            FakeimgProvider::fakeImgUrl(
                800,
                600,
                'foo & bar',
    ...
    {
        $this->assertSame(
            'https://fakeimg.cnbattle.com/800x600/FF0000,128/000000,10?retina=1&text=foo+%26+bar',
            FakeimgProvider::fakeImgUrl(
                800,
                600,
                'foo & bar',
